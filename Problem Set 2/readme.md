...
- [camel.py](camel.py) – canelCase
- [coke.py](coke.py) – Coke Machine
- [nutrition.py](nutrition.py) – Nutrition Facts
- [plates.py](plates.py) – Vanity Plates
- [twttr.py](twttr.py) – Just setting up my twttr 
